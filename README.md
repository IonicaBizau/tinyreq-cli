...
```sh
# Using npm
npm install --global tinyreq-cli

# Using yarn
yarn global add tinyreq-cli
```

:bulb: **ProTip**: If you want to use this package as module, check out [`tinyreq`—the API version of it](https://github.com/IonicaBizau/tinyreq).
